...
type
  ...
  TAnimated = class;
  TBlackWhite = class;
  TBrilliantDiamondShiningPearl = class;
  TCrystal = class;
  TDiamondPearl = class;
  TDreamWorld = class;
  TEmerald = class;
  ...
  TGenerationViii = class
  private
    [JSONName('brilliant-diamond-shining-pearl')]
    FBrilliantDiamondShiningPearl: TBrilliantDiamondShiningPearl;
    FIcons: TIcons;
  published
    property BrilliantDiamondShiningPearl: TBrilliantDiamondShiningPearl read FBrilliantDiamondShiningPearl;
  ...
  TGenerationIx = class
  private
    [JSONName('scarlet-violet')]
    FScarletViolet: TScarletViolet;
  published
    property ScarletViolet: TScarletViolet read FScarletViolet;
  public
    constructor Create;
    destructor Destroy; override;
  end;
  ...
  private
    ...
    [JSONName('generation-ix')]
    FGenerationIx: TGenerationIx;
  ...
  published
    ...
    property GenerationIx: TGenerationIx read FGenerationIx;
  ...
  private
    ...
    [JSONName('past_stats'), JSONMarshalled(False)]
    FPastStatsArray: TArray<TPastStats>;
    [GenericListReflect]
    FPastStats: TObjectList<TPastStats>;
    ...
    function GetPastStats: TObjectList<TPastStats>;
  ...
  published
    ...
    property PastStats: TObjectList<TPastStats> read GetPastStats;
...
begin
  inherited;
  FBrilliantDiamondShiningPearl := TBrilliantDiamondShiningPearl.Create;
  FIcons := TIcons.Create;
end;

destructor TGenerationViii.Destroy;
begin
  FBrilliantDiamondShiningPearl.Free;
  FIcons.Free;
  inherited;
end;
...
constructor TGenerationIx.Create;
begin
  inherited;
  FScarletViolet := TScarletViolet.Create;
end;

destructor TGenerationIx.Destroy;
begin
  FScarletViolet.Free;
  inherited;
end;
...
begin
  ...
  FGenerationIx := TGenerationIx.Create;
...
constructor TPastStats.Create;
begin
  inherited;
  FGeneration := TGeneration.Create;
end;

destructor TPastStats.Destroy;
begin
  FGeneration.Free;
  GetStats.Free;
  inherited;
...
function TPastStats.GetStats: TObjectList<TStats>;
begin
  Result := ObjectList<TStats>(FStats, FStatsArray);
end;

function TPastStats.GetAsJson: string;
begin
...
function TPokemon.GetPastStats: TObjectList<TPastStats>;
begin
  Result := ObjectList<TPastStats>(FPastStats, FPastStatsArray);
end;
...
begin
  ...
  RefreshArray<TPastStats>(FPastStats, FPastStatsArray);
