...
const
  ...
  (
    (Name: 'APessoa'; Direction: 1; DBXType: 37; TypeName: 'TPessoa'),
...
function TServerMethods1Client.SetPessoaNativo(APessoa: TPessoa; const ARequestFilter: string): Boolean;
begin
  ...
  begin
    ...
    try
      FSetPessoaNativoCommand.Parameters[0].Value.SetJSONValue(FMarshal.Marshal(APessoa), True);
      if FInstanceOwner then
        APessoa.Free
    finally
      FreeAndNil(FMarshal)
